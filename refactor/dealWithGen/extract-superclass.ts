...
2.  Use [Pull Up Field](/pull-up-field), [Pull Up
    Method](/pull-up-method), and [Pull Up Constructor
    Body](/pull-up-constructor-body) to move the common functionality to
    a superclass. Start with the fields, since in addition to the common
    fields you will need to move the fields that are used in the common
    methods.
