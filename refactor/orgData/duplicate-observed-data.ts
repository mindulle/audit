...
-   This refactoring technique, which in its classic form is performed
    using the Observer template, isn't applicable for web apps, 
...
1.  Hide direct access to domain data in the *GUI class*. 
    For this, it's best to use Self Encapsulate Field. 
