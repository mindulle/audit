...
- Replace Type Code With Subclasses. Subclasses will be
...
- Replace Type Code With State Strategy. 
  A class will be dedicated for a particular object property and subclasses will be created from it for each value of the property. The current class will contain references to the objects of this type and delegate execution to them.
